"""
The code presented here is mostly extracted from the GitHub repository: https://github.com/thibaultlaugel/growingspheres/blob/master/growingspheres/growingspheres.py
...
"""
from gs_support import generate_ball, generate_sphere, generate_ring, get_distances
...
class GrowingSpheres:
    ...
    def find_counterfactual(self):
        ...
        if not self.several:
            ...
            all_ennemies_ = sorted(ennemies_, 
        ...
        while n_ennemies_ > 0:
            ...
            if self.several == False:
                ...
                while n_ennemies_ <= self.amount:
                    ...
                    radius_ = radius_ + step_
                    iteration += 1
                    # print(f'radius: {np.round(radius_,5)}')
